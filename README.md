...
|      `IDP_JWKS_PATH`      | This variable should point to a file (e.g.) `jwks.json` that contains the public key information for the `.well-known` endpoint (The contents of this file can be generated with the command `coddin:jwk:generate`) |
